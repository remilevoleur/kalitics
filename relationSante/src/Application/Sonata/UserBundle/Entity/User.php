...
class User extends BaseUser
{
    ...
    /**
     * Get disponibilites hebdomadaires.
     *
     * @return \Doctrine\Common\Collections\Collection
     */
    public function getDisponibilitesHebdomadaires(){
        $disponibilitesHebdomadaires = new \Doctrine\Common\Collections\ArrayCollection();

        foreach ($this->disponibilites as $disponibilite) {
            if($disponibilite->getType() == "hebdomadaire"){
                $disponibilitesHebdomadaires->add($disponibilite);
            }
        }

        return $disponibilitesHebdomadaires;
    }
}
